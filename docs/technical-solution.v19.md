# novel-multi-agent V19 Technical Solution: Artifact Export Contract

## 方案概览

实现 `CLI artifact-export --schema v2`。Core 继续提供纯函数 contract；CLI 负责参数、文件扫描和 JSON 输出；Web 只追加零依赖 inline helper / 可见入口。
