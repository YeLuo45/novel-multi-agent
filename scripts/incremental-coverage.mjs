...
const targets = {
  ...
  'packages/cli/src/web-studio.ts': ['buildWebNavigation', 'buildWebOnboarding', 'buildWebHelp', 'buildWebDefaultView', 'buildInteractivePanel', 'buildChapterEditor', 'computeWordStats', 'planChapterSave', 'buildChapterContext', 'appendChapterRevision', 'buildForeshadowingGraphSvg', 'buildCharacterArcSvg', 'buildChapterPacingSvg', 'buildRevisionTree', 'buildTagIndex', 'searchProjectsIndexed', 'planIndexedDbMigration', 'buildDiffView', 'buildImportWizard', 'computeDailyGoal', 'buildHeatmapSvg', 'planFocusSession', 'planUndoEntry', 'buildPwaManifest', 'buildServiceWorkerPlan', 'renderServiceWorkerScript', 'assessOfflineCapability', 'buildPipelineTimelineSvg', 'buildAgentTraceView', 'parseArtifactIndex', 'planArtifactSync', 'buildIndexedDbSchema', 'buildIndexedDbAdapter', 'buildMigrationScript', 'renderMarkdown', 'extractMarkdownOutline', 'buildRichTextToolbar', 'buildUndoStackConfig', 'pushUndoEntry', 'popUndoEntry', 'planUndoRestore', 'computeUndoStats', 'buildIndexedDbRuntime', 'planIndexedDbBatch', 'assessIndexedDbQuota', 'buildChapterDocument', 'switchChapterView', 'planChapterEdit', 'planKeyboardShortcut', 'buildChapterShortcutBindings', 'buildRedoStackConfig', 'pushRedoEntry', 'popRedoEntry', 'planRedoForward', 'buildIdbExecutor', 'planIdbMigration', 'buildTuiMirror', 'planIdbExecution', 'parseReplCommand', 'planReplDispatch', 'buildReplHelp', 'planCliCommand', 'buildThemeConfig', 'buildThemeOptions', 'planThemeMigration', 'buildIdbMockHandle', 'simulateIdbRuntime', 'planIdbRecovery', 'buildIdbIntegrationTestCases', 'runIdbIntegrationTest', 'assessIdbIntegrationCoverage', 'buildTuiKeymap', 'planTuiNavigate', 'buildTuiCommands', 'buildTuiKeyEvent', 'planTuiKeyBindings', 'buildTuiActiveSection', 'buildIdbExecutorCode', 'parseIdbEvalError', 'simulateIdbEval', 'buildIdbInMemoryHandle', 'runIdbInMemoryOps', 'buildIdbPersistenceAdapter', 'planPersistenceBackup', 'planPersistenceRestore', 'computePersistenceChecksum', 'buildBrowserEvalAdapter', 'planBrowserEvalSteps', 'simulateBrowserEval', 'buildTuiSectionVisual', 'planTuiHighlight', 'buildTuiScrollPlan', 'runBrowserEval', 'extractBrowserEvalError', 'planBrowserEvalRetry', 'buildTuiScrollIntoView', 'planTuiSmoothScroll', 'buildTuiKeyboardFocus', 'serializePersistencePayload', 'verifyPersistenceReadback', 'planPersistenceDualWrite', 'runDualWrite', 'extractDualWriteError', 'planDualWriteRecovery', 'runTuiScrollIntoView', 'planTuiAnimation', 'buildTuiSectionElement', 'evalIdbFallbackWrite', 'verifyIdbFallback', 'planIdbFallbackRecovery', 'buildRealIndexedDBStore', 'runRealIndexedDBOp', 'extractRealIndexedDBError', 'persistFallbackToProjectsStore', 'restoreFallbackFromProjectsStore', 'planFallbackMigration', 'runRealDualWrite', 'extractRealDualWriteError', 'planRealDualWriteRecovery', 'validateBrowserDualWrite', 'buildBrowserDualWriteCode', 'runBrowserDualWrite', 'validateBrowserFallback', 'buildBrowserFallbackCode', 'runBrowserFallbackWrite'],
};
