...
const targets = {
  ...
  'packages/cli/src/web-studio.ts': ['buildWebNavigation', 'buildWebOnboarding', 'buildWebHelp', 'buildWebDefaultView', 'buildInteractivePanel', 'buildChapterEditor', 'computeWordStats', 'planChapterSave', 'buildChapterContext', 'appendChapterRevision'],
};
